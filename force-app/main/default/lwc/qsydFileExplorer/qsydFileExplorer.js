	...
	handleItemAction(e) {
		...
		switch (e.detail) {
			...
			default:
                ...
                console.log('handleItemAction: switch: default: this.item = ' + this.item);
                console.log('handleItemAction: switch: default: this.dataDictionary.folders = ' + this.dataDictionary.folders);
				...
				this.explorerManagementHeader = interpolate(
                    ...
                    console.log('handleItemAction: switch: default: this.explorerManagementHeader = ' + this.explorerManagementHeader);
